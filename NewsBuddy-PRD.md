# News Intelligence RAG System — **NewsBuddy**
...
| ------------------ | ------------- |
| Precision@K        | ≥ 0.7         |
| Answer Correctness | High (manual) |
| Latency            | < 3 seconds   |
...
### 6.7 Reranking (Planned)

* Cross-encoder reranker (future enhancement)

### 6.8 LLM Generation

* OpenAI model (GPT-4 class)
...
| Outdated information | Daily ingestion                |
